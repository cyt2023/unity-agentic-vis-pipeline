...
`StreamingAssets/test3_workflow.json -> workflow runtime -> CSV read -> operator execution -> backend-result adaptation -> existing renderer`
...
- `Assets/Scripts/WorkflowRuntime/Core/*`
- `Assets/Scripts/WorkflowRuntime/Data/*`
- `Assets/Scripts/WorkflowRuntime/View/*`
- `Assets/Scripts/WorkflowRuntime/Query/*`
- `Assets/Scripts/WorkflowRuntime/Filter/*`
- `Assets/Scripts/WorkflowRuntime/Backend/*`
- `Assets/Scripts/WorkflowRuntime/Runner/*`
- `Assets/Scripts/Integration/Runtime/WorkflowRuntimeBackendResultAdapter.cs`
- `Assets/Scripts/Integration/Runtime/WorkflowRuntimeRenderCoordinator.cs`
...
- `WorkflowRuntimeDemoController` now defaults to `test3_workflow.json`
